...
export interface ApiExperienceExperience extends Schema.SingleType {
  ...
  attributes: {
    experience_block: Attribute.Component<
...
export interface ApiHomeHome extends Schema.SingleType {
  ...
  attributes: {
    ...
    slide_9: Attribute.Media<'images' | 'files' | 'videos' | 'audios'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    slide_10: Attribute.Media<'images' | 'files' | 'videos' | 'audios'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    slide_11: Attribute.Media<'images' | 'files' | 'videos' | 'audios'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    slide_12: Attribute.Media<'images' | 'files' | 'videos' | 'audios'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    slide_13: Attribute.Media<'images' | 'files' | 'videos' | 'audios'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    chefs_block: Attribute.Component<'chefs-block.chefs-block'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiMenuDishMenuDish extends Schema.CollectionType {
  collectionName: 'menu_dishes';
  info: {
    singularName: 'menu-dish';
    pluralName: 'menu-dishes';
    displayName: 'Menu Dish';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    ...
    category: Attribute.Enumeration<
      ['shared', 'sea', 'meat', 'vegetal', 'dessert']
    > &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiOpeningOpening extends Schema.CollectionType {
  ...
  attributes: {
    day_range: Attribute.String &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    hour_range_first: Attribute.String &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    hour_range_last: Attribute.String &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
